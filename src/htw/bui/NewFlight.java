...
/**
 * Activity für die Darstellung eines Formulars zur Eingabe der Daten eines
 * zurückgelegten Fluges und anschließenden Berechnung der Emissionen/ des
 * Wasserverbrauchs auf Basis von Emissionsfaktoren. Schließlich wird der
...
public class NewFlight extends OrmLiteBaseActivity<DatabaseHelper>  {
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		/**
		 * Wurde das Formular zum Editieren einer bestehenden Flug-Position geöffnet wurde,
...
//	        	 int choosenDistanceType = distanceType.getSelectedItemPosition();    
     ...
     * das Formular für das Editieren eines bestehenden Fluges geöffnet wurde, werden die Daten
     * aktualisiert.
     */
